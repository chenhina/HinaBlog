# Generated by Django 3.2.2 on 2021-06-03 08:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.FileField(default='avatar/default.jpg', upload_to='avatar/', verbose_name='头像')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('blog', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app01.site')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('comment_msg', models.CharField(max_length=255, verbose_name='评论内容')),
                ('comment_time', models.DateField(auto_now_add=True, verbose_name='评论日期')),
                ('article', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.article')),
        ...
        migrations.AddField(
            model_name='article',
            name='content',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='app01.content'),
        ),
        migrations.AddField(
            model_name='article',
            name='tag',
        ...
        migrations.AddField(
            model_name='userinfo',
            name='blog',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='app01.site'),
        ),
        migrations.AddField(
            model_name='userinfo',
            name='groups',
